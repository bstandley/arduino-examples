...
const char          conf_idn               [ESLEN] = "SDI DIGITAL I/O CONTROLLER";
...
const char          conf_reply_na          [ESLEN] = "WARNING: NOT APPLICABLE";
...
void setup()
{
    ...
    EEPROM.put(EPA_REPLY_NA,          conf_reply_na);
...
void loop()
{
    ...
    check_eps(EPA_REPLY_NA,          "EPA_REPLY_NA");
