...
lanvars_short   = [':SYST:COMM:LAN:MODE',          ':SYST:COMM:LAN:MAC',          ':SYST:COMM:LAN:IP',          ':SYST:COMM:LAN:GATE',             ':SYST:COMM:LAN:SUB',             ':SYST:COMM:LAN:IP:STAT',            ':SYST:COMM:LAN:GATE:STAT',               ':SYST:COMM:LAN:SUB:STAT']
