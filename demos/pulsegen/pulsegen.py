...
basevars_full   = ['*IDN',':TRIG:EDGE', ':TRIG:ARMED', ':TRIG:READY', ':TRIG:REARM', ':TRIG:COUNT', ':CLOCK:SRC', ':CLOCK:FREQ', ':CLOCK:FREQ:MEASURE', ':CLOCK:FREQ:INTERNAL', ':CLOCK:FREQ:EXTERNAL']
