...
basevars_full   = ['*IDN',':TRIGGER:EDGE', ':TRIGGER:ARMED', ':TRIGGER:READY', ':TRIGGER:REARM', ':TRIGGER:COUNT', ':CLOCK:SRC', ':CLOCK:FREQUENCY', ':CLOCK:FREQUENCY:MEASURE', ':CLOCK:FREQUENCY:INTERNAL', ':CLOCK:FREQUENCY:EXTERNAL']
basevars_short  = ['*IDN',':TRIG:EDGE',    ':TRIG:ARM',      ':TRIG:READY',    ':TRIG:REARM',    ':TRIG:COUN',     ':CLOCK:SRC', ':CLOCK:FREQ',      ':CLOCK:FREQ:MEAS',         ':CLOCK:FREQ:INT',           ':CLOCK:FREQ:EXT']
